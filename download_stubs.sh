...
CPY_BUNDLE_COMMUNITY=https://github.com/adafruit/CircuitPython_Community_Bundle/releases/download/${20241110}/circuitpython-community-bundle-py-${20241110}.zip
...
curl -fsSL -o cpy-bundle-community-py.zip "${CPY_BUNDLE}"
